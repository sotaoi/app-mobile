...
function metroImportDefault(moduleId) {
  ...
  const importedDefault = exports && exports.__esModule ? exports.default : exports; // $FlowFixMe The metroRequire call above will throw if modules[id] is null
  ...
  const metroHotUpdateModule = function (id, factory, dependencyMap, inverseDependencies) {
    ...
    for (let i = 0; i < updatedModuleIDs.length; i++) {
      ...
      if (refreshBoundaryIDs.has(updatedID)) {
        ...
        const isNoLongerABoundary = !isReactRefreshBoundary(Refresh, nextExports); // It can also become ineligible if its exports are incompatible
  ...
  const performFullRefresh = (reason, modules) => {
    ...
    if (typeof window !== 'undefined' && window.location != null && typeof window.location.reload === 'function') {
      ...
      if (Refresh != null) {
        ...
        const sourceName =
          (_ref2 =
            (_modules$source = modules.source) === null || _modules$source === void 0
              ? void 0
        ...
        const failedName =
          (_ref3 =
            (_modules$failed = modules.failed) === null || _modules$failed === void 0
              ? void 0
